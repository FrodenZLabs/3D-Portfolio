...
const Experience = () => {
  useGSAP(() => {
    ...
    // Loop through each expText element and animate them in as the user scrolls to each text element
  ...
  return (
    <section id="experience" className="flex-center mt-20 md:mt-40">
